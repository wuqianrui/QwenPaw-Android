...
> **协议详情**：QwenPaw 的 API 基于 AgentScope Runtime 协议的拓展。更多详细信息请参考： [AgentScope Runtime 协议文档（中文）](https://runtime.agentscope.io/zh/protocol.html)

> ⚠️ **安全提醒**： 如果您的 QwenPaw 实例对**公网开放**，强烈建议启用 [Web 登录认证](https://qwenpaw.agentscope.io/docs/security#Web-%E7%99%BB%E5%BD%95%E8%AE%A4%E8%AF%81)！ 未启用认证的公网实例存在严重安全风险，任何人都可以访问和控制您的 Agent。 详见文档末尾的 [Web 认证令牌](#web-%E8%AE%A4%E8%AF%81%E4%BB%A4%E7%89%8C%E5%8F%AF%E9%80%89) 章节。
...
> **提示**：如果启用了 [Web 登录认证](https://qwenpaw.agentscope.io/docs/security#Web-%E7%99%BB%E5%BD%95%E8%AE%A4%E8%AF%81)并从远程访问，需要提供身份验证令牌。详见文档末尾的 [Web 认证令牌](#web-%E8%AE%A4%E8%AF%81%E4%BB%A4%E7%89%8C%E5%8F%AF%E9%80%89) 部分。
...
如果启用了 [Web 登录认证](https://qwenpaw.agentscope.io/docs/security#Web-%E7%99%BB%E5%BD%95%E8%AE%A4%E8%AF%81)（`QWENPAW_AUTH_ENABLED=true`），所有 API 请求都需要提供身份验证令牌。
...
*   [Console 使用指南](https://qwenpaw.agentscope.io/docs/console)
*   [安全设置](https://qwenpaw.agentscope.io/docs/security)
*   [多智能体](https://qwenpaw.agentscope.io/docs/multi-agent)
...
1.  查看 [FAQ](https://qwenpaw.agentscope.io/docs/faq) 了解常见问题
2.  加入 [社区](https://qwenpaw.agentscope.io/docs/community) 寻求帮助
